...
var Drawer = _interopDefault(require('@vtex-components/drawer'));
var merge = _interopDefault(require('deepmerge'));
var base = _interopDefault(require('@theme-ui/preset-base'));
var React = require('react');
var React__default = _interopDefault(React);
var Link = _interopDefault(require('gatsby-link'));
var gatsbyPluginI18n = require('@vtex/gatsby-plugin-i18n');
var BaseAccordion = _interopDefault(require('@vtex-components/accordion'));
...
var Header = function Header(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    variant: variant,
    as: "header"
  }, children);
};
...
var LocalizedLink = function LocalizedLink(props) {
  ...
  var href = gatsbyPluginI18n.useLocalizedPath(props.to);
  return (// @ts-ignore
    React__default.createElement(Link, Object.assign({}, linkProps, {
      to: href
    }), children)
  );
};
...
var Logo = function Logo(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, Object.assign({}, props), React__default.createElement("svg", {
    version: "1.1",
    id: "Layer_1",
    ...
    viewBox: viewBox,
    xmlSpace: "preserve"
  }, React__default.createElement("title", null, title), React__default.createElement("image", {
    id: "image0",
    x: "0",
    y: "0",
    href: src
...
var ProgressiveImage = function ProgressiveImage(_ref) {
  ...
  var _useState = React.useState(placeholderProps),
      current = _useState[0],
  ...
  return React__default.createElement(Component, Object.assign({}, commonProps, current));
};
...
var InfoCardImage = function InfoCardImage(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    variant: "card.image"
  }, React__default.createElement(themeUi.Flex, Object.assign({}, linkProps), React__default.createElement(themeUi.Image, {
...
var InfoCardInfo = function InfoCardInfo(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    variant: "card.info"
  }, title && React__default.createElement(themeUi.Heading, {
    variant: "card.info.title"
  }, title), description && React__default.createElement(themeUi.Text, {
    variant: "card.info.description"
  }, description), children && React__default.createElement(themeUi.Flex, {
...
var InfoCardInfoAction = function InfoCardInfoAction(_ref) {
  ...
  return React__default.createElement(themeUi.Button, Object.assign({}, props), label);
};
...
var MinicartButton = function MinicartButton(_ref) {
  ...
  return themeUi.jsx(themeUi.Button, Object.assign({
...
var MinicartContent = function MinicartContent(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    ...
    }, React__default.createElement(themeUi.Box, Object.assign({}, imageProps(item)))), React__default.createElement(themeUi.Flex, {
      variant: customVariant + ".product.name"
    }, React__default.createElement(themeUi.Text, {
      variant: customVariant + ".product.name.text"
    }, item.name), React__default.createElement(themeUi.Text, {
...
var MinicartDrawerPrice = function MinicartDrawerPrice(_ref) {
  ...
  }, text), React__default.createElement(themeUi.Text, {
...
var Banner = function Banner(_ref) {
  ...
  return themeUi.jsx(LocalizedLink, {
    to: href
  }, themeUi.jsx(themeUi.Image, {
    src: src,
    alt: alt,
    width: width,
    height: height,
...
var ArrowUp = /*#__PURE__*/React__default.createElement("path", {
...
var ArrowDown = /*#__PURE__*/React__default.createElement("path", {
...
var SearchFilterAccordionCollaipsibleIcon = function SearchFilterAccordionCollaipsibleIcon(_ref) {
  ...
  return React__default.createElement(themeUi.Box, {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    xmlnsXlink: "http://www.w3.org/1999/xlink"
  }, React__default.createElement("g", null, isActive ? ArrowUp : ArrowDown)));
};
...
var SearchFilterAccordion = function SearchFilterAccordion(_ref) {
  ...
  var defaultRenderIcon = React.useCallback(function (active) {
    return React__default.createElement(SearchFilterAccordionCollaipsibleIcon, {
      isActive: active,
  ...
  return React__default.createElement(BaseAccordion, {
    variant: variant,
    mode: "multiOpen",
    renderIcon: renderIcon !== null && renderIcon !== void 0 ? renderIcon : defaultRenderIcon
  }, filters.map(function (filter, index) {
    return React__default.createElement(BaseAccordion.Section, {
...
var SearchFilterAccordionItemCheckbox = function SearchFilterAccordionItemCheckbox(_ref) {
  var _ref$item = _ref.item,
      ...
      item = _ref.item;
  return React__default.createElement(themeUi.Label, {
    onClick: function onClick(e) {
      e.preventDefault();

      _onClick(item);
    }
  }, React__default.createElement(themeUi.Checkbox, {
    variant: variant + ".checkbox",
    checked: selected,
    readOnly: true
  }), React__default.createElement(themeUi.Box, {
    variant: variant + ".value"
  }, name), React__default.createElement(themeUi.Box, {
...
var SearchControlsFiltersButton = function SearchControlsFiltersButton(_ref) {
  ...
  return React__default.createElement(themeUi.Button, Object.assign({
    variant: variant
  }, props), label, React__default.createElement("svg", {
    fill: "none",
    width: "16",
    height: "16",
    viewBox: "0 0 17 17",
...
var SearchControlsTotalCount = function SearchControlsTotalCount(_ref) {
  ...
  return React__default.createElement(themeUi.Box, {
    variant: variant
  }, React__default.createElement("span", null, totalCount), label);
};
...
var SearchControlsSelect = function SearchControlsSelect(_ref) {
  ...
  return React__default.createElement(themeUi.Select, Object.assign({
...
var Breadcrumb = function Breadcrumb(_ref) {
  ...
  return React__default.createElement(themeUi.Flex, {
    ...
    to: "/",
    "aria-label": "Home"
  }, React__default.createElement(themeUi.Flex, Object.assign({
    as: "svg",
    variant: "breadcrumb.homeIcon"
  }, homeSvgProps), React__default.createElement("path", {
    ...
    }, caretSvgProps), React__default.createElement("path", {
...
var SliderArrowLeft = function SliderArrowLeft(props) {
  return React__default.createElement(themeUi.Box, Object.assign({}, props, {
    as: "button",
    variant: props.variant + ".arrow.left.button"
  }), React__default.createElement(themeUi.Box, Object.assign({
    as: "svg"
  }, svgProps, {
...
var useSlider = function useSlider(_ref) {
  ...
  var setNextPage = React.useCallback(function () {
    return setPage(function (p) {
      return next(p, totalPages);
    });
  }, [totalPages]);
  var setPreviousPage = React.useCallback(function () {
    return setPage(function (p) {
...
var useResponsiveSlider = function useResponsiveSlider(_ref) {
  ...
  var pageSize = matchMedia.useResponsiveValue(pageSizes, {
...
var ProductSpecificationTitle = function ProductSpecificationTitle(_ref) {
  var _ref$variant = _ref.variant,
      variant = _ref$variant === void 0 ? 'productSpecification' : _ref$variant,
      children = _ref.children;
  return React__default.createElement(themeUi.Heading, {
...
var ProductSpecification = function ProductSpecification(_ref) {
  var _ref$variant = _ref.variant,
      variant = _ref$variant === void 0 ? 'productSpecification' : _ref$variant,
      data = _ref.data;
  return React__default.createElement(React__default.Fragment, null, data === null || data === void 0 ? void 0 : data.map(function (group) {
    return React__default.createElement(React.Fragment, {
      key: group === null || group === void 0 ? void 0 : group.name
    }, React__default.createElement(ProductSpecificationTitle, {
      variant: variant
    }, group === null || group === void 0 ? void 0 : group.name), React__default.createElement(ProductSpecificationItem, {
      variant: variant,
...
var NumericStepper = function NumericStepper(_ref) {
  ...
  var narrowedValue = React.useCallback(function (value) {
    return Math.min(Math.max(value, minValue), maxValue);
  }, [maxValue, minValue]);
  var updateQuantity = React.useCallback(function (value) {
  ...
  return React__default.createElement(React.Fragment, null, React__default.createElement(themeUi.Flex, {
    variant: variant + ".numericStepper"
  }, React__default.createElement(themeUi.Button, {
    variant: variant + ".numericStepper.button.minus",
    onClick: function onClick() {
      return updateQuantity(quantity - 1);
    },
    disabled: isMin
  }, "-"), React__default.createElement(themeUi.Input, {
    id: id,
    value: quantity,
    type: "number",
...
var ProductSummaryImage = function ProductSummaryImage(_ref) {
  var _ref$loading = _ref.loading,
      ...
      src = _ref.src,
      alt = _ref.alt;
  return React__default.createElement(themeUi.AspectImage, {
...
var ProductSummaryContainer = function ProductSummaryContainer(_ref) {
  ...
  return themeUi.jsx(LocalizedLink, Object.assign({
    state: {
      fromSummary: true
    },
    sx: {
...
var FloatingActionButton = function FloatingActionButton(_ref) {
  ...
  }, React__default.createElement(ButtonBox, Object.assign({
    as: "button",
...
var GiftListList = function GiftListList(_ref) {
  ...
  return React__default.createElement(themeUi.Box, {
    ...
    return React__default.createElement(themeUi.Box, {
      key: "giftlist." + index,
      as: "li"
    }, React__default.createElement(ItemComponent, Object.assign({}, item)));
  }));
};
...
var Skeleton = function Skeleton(_ref) {
  ...
  return core.jsx("div", {
    css: core.css(_templateObject(), baseColor, width, height, core.keyframes(_templateObject2(), width))
  });
};
...
var Youtube = function Youtube(props) {
  ...
  return React__default.createElement(themeUi.Box, Object.assign({}, iframeProps, {
    as: "iframe"
  }));
};
...
var Video = function Video(props) {
  ...
  return React__default.createElement(themeUi.AspectRatio, {
    ratio: 1,
    sx: {
      paddingTop: '20%'
    }
  }, React__default.createElement(themeUi.AspectRatio, {
    ratio: 4 / 3
  }, React__default.createElement(Youtube, Object.assign({}, props, {
    sx: {
      width: '100%',
      height: '100%'
    },
...
Object.keys(themeUi).forEach(function (k) {
...
exports.GiftListList = GiftListList;
exports.GiftListTitle = GiftListTitle;
exports.Header = Header;
exports.InfoCard = InfoCard;
exports.InfoCardImage = InfoCardImage;
exports.InfoCardInfo = InfoCardInfo;
exports.InfoCardInfoAction = InfoCardInfoAction;
exports.LocalizedLink = LocalizedLink;
exports.Logo = Logo;
exports.MinicartBadge = MinicartBadge;
exports.MinicartButton = MinicartButton;
exports.MinicartButtonSvg = MinicartButtonSvg;
exports.MinicartContent = MinicartContent;
exports.MinicartDrawer = MinicartDrawer;
exports.MinicartDrawerPrice = MinicartDrawerPrice;
exports.NumericStepper = NumericStepper;
exports.OfferContainer = OfferContainer;
exports.OfferDiscountBadge = OfferDiscountBadge$1;
exports.OfferInstallments = OfferDiscountBadge;
exports.OfferListPrice = OfferListPrice;
exports.OfferPrice = OfferPrice;
exports.OfferSoldOut = OfferSoldOut;
exports.ProductDescription = ProductDescription;
exports.ProductDescriptionTitle = ProductDescriptionTitle;
exports.ProductDetailsGallery = ProductDetailsGallery;
exports.ProductDetailsReference = ProductDetailsReference;
exports.ProductDetailsTitle = ProductDetailsTitle;
exports.ProductQuantityTitle = ProductQuantityTitle;
exports.ProductSpecification = ProductSpecification;
exports.ProductSpecificationItem = ProductSpecificationItem;
exports.ProductSpecificationTitle = ProductSpecificationTitle;
exports.ProductSummaryContainer = ProductSummaryContainer;
exports.ProductSummaryImage = ProductSummaryImage;
exports.ProductSummaryTitle = ProductSummaryTitle;
exports.ProgressiveImage = ProgressiveImage;
exports.ResponsivePicture = ResponsivePicture;
exports.RichMarkdown = RichMarkdown;
exports.SearchControls = SearchControls;
exports.SearchControlsFiltersButton = SearchControlsFiltersButton;
exports.SearchControlsSelect = SearchControlsSelect;
exports.SearchControlsTotalCount = SearchControlsTotalCount;
exports.SearchFilterAccordion = SearchFilterAccordion;
exports.SearchFilterAccordionItemCheckbox = SearchFilterAccordionItemCheckbox;
exports.Skeleton = Skeleton;
exports.SliderArrowLeft = SliderArrowLeft;
exports.SliderArrowRight = SliderArrowRight;
exports.SliderPaginationDots = SliderPaginationDots;
exports.VideoIframe = Video;
exports.baseTheme = baseTheme;
exports.breadcrumbTheme = breadcrumbTheme;
exports.createTheme = createTheme;
exports.debounce = debounce;
exports.floatingActionButtonTheme = floatingActionButtonTheme;
exports.headerTheme = headerTheme;
exports.infoCardTheme = CardTheme;
exports.minicartTheme = minicartTheme;
exports.productDescriptionTheme = productDescriptionTheme;
exports.productQuantityTheme = productQuantityTheme;
exports.productSpecificationTheme = productSpecificationTheme;
exports.responsivePictureTheme = responsivePicture;
exports.searchControlsTheme = searchControlsTheme;
exports.searchFilterTheme = searchFilterTheme;
exports.throttle = throttle;
exports.useInterval = useInterval;
exports.useResponsiveSlider = useResponsiveSlider;
