...
const SearchBarInput = (_a) => {
    ...
    return (react_1.default.createElement(store_ui_1.Box, { variant: `${variant}.textInput`, ref: referenceRef },
        react_1.default.createElement(store_ui_1.PopoverDisclosure, Object.assign({ toggle: toggle, as: "input", type: "search", role: "searchbox" }, forward, popover, { ref: ref, unstable_referenceRef: referenceRef, onChange: (e) => {
        ...
        react_1.default.createElement(store_ui_1.Popover, Object.assign({ tabIndex: 0, "aria-label": "Searchbar Input" }, popover), visible ? children : null)));
};
