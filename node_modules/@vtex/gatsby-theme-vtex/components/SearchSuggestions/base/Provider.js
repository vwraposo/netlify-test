...
const SearchSuggestionsProvider = ({ children }) => {
    ...
    return (react_1.default.createElement(hooks_1.SearchSuggestionsContext.Provider, { value: {
            term,
            setTerm,
            searchBar: searchbarContext,
        } },
        react_1.default.createElement(store_ui_1.Flex, { variant: "suggestions" }, children)));
};
