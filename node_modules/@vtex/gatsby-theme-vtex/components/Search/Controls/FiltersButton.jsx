...
exports.SearchControlsFiltersButton = (_a) => {
    ...
    return (<>
      <store_ui_1.SearchControlsFiltersButton label={formatMessage({ id: 'searchControls.filters' })} variant={variant} onClick={toggle}/>
      {active ? (<react_1.Suspense fallback={null}>
