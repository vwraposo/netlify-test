...
const List = ({ initialData, columns, pageSize }) => {
    ...
    if (!data) {
        return react_1.default.createElement(OverlaySpinner_1.default, null);
    }
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(store_ui_1.Grid, { variant: "search", columns: columns }, data.map((searchQuery, index) => (react_1.default.createElement(Page_1.default, { key: `summary-page-${index}`, products: searchQuery.vtex.productSearch.products })))),
        react_1.default.createElement(store_ui_1.Button, { variant: "loadMore", onClick: (e) => {
                var _a, _b;
                ;
                (_b = (_a = e.target).blur) === null || _b === void 0 ? void 0 : _b.call(_a);
                fetchMore();
            }, "aria-label": loadMoreLabel, disabled: isReachingEnd || isLoadingMore }, isReachingEnd ? '' : isLoadingMore ? loadingLabel : loadMoreLabel)));
};
