...
const CustomMinicartDrawer = ({ isOpen, onClose, variant, }) => {
    ...
    return (react_1.default.createElement(store_ui_1.MinicartDrawer, { variant: variant, isOpen: isOpen, placement: "right", onClose: onClose, width: 400 },
        react_1.default.createElement(Header_1.HeaderMinicartDrawerHeader, { onClose: onClose, count: count, variant: customVariant }),
        react_1.default.createElement(Content_1.HeaderMinicartDrawerContent, Object.assign({}, contentData, { imageElement: store_ui_1.AspectImage, variant: customVariant })),
        react_1.default.createElement(Footer_1.HeaderMinicartDrawerFooter, { variant: customVariant })));
};
