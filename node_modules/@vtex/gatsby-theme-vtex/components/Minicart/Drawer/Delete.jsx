...
const MinicartDelete = (props) => {
    ...
    return (<store_ui_1.Button {...useDelete}>
      {isLoading ? (<store_ui_1.Spinner width={24} height={24}/>) : (<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
...
exports.default = MinicartDelete;
