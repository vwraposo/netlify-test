...
const Minicart = () => {
    ...
    return (store_ui_1.jsx(react_1.Fragment, null,
        store_ui_1.jsx(Button_1.default, { variant: customVariant, onClick: toggle }),
        isOpen ? (store_ui_1.jsx(react_1.Suspense, { fallback: null },
            store_ui_1.jsx(MinicartDrawer, { variant: customVariant, isOpen: true, onClose: toggle }))) : null));
};
