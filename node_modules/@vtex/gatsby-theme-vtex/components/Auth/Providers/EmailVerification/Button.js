...
const EmailVerificationButton = (_a) => {
    var { variant } = _a, rest = __rest(_a, ["variant"]);
    const { formatMessage } = gatsby_plugin_i18n_1.useIntl();
    return (react_1.default.createElement(store_ui_1.Button, Object.assign({ variant: `${variant}.emailVerification`, as: "button" }, rest), formatMessage({
        id: 'login.page.emailVerification.button',
        defaultMessage: 'Receive access code by e-mail',
    })));
};
exports.default = EmailVerificationButton;
