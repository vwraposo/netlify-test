...
const EmailVerification = ({ variant: v, returnUrl, }) => {
    ...
    return state.state.startsWith('emailForm') ? (react_1.default.createElement(EmailForm_1.default, { state: state, variant: variant, onSubmit: (email) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }) })) : (react_1.default.createElement(AccessCodeForm_1.default, { state: state, variant: variant, onBack: () => dispatch({ type: 'emailForm' }), onSubmit: (code) => __awaiter(void 0, void 0, void 0, function* () {
            const { email } = state;
