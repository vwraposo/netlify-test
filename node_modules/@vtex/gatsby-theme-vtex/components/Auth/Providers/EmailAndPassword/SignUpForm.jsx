...
const SignUpForm = ({ variant, onSubmit, onBack, state: { state, email }, }) => {
    ...
    return (<>
      ...
      <store_ui_1.Box as="form" onSubmit={(e) => {
        ...
        <store_ui_1.Input ref={code} type="text" name="code" id="code" placeholder={formatMessage({
        id: 'login.page.emailAndPassword.signUpForm.accessCodePlaceholder',
        defaultMessage: 'Add your access code',
    })}/>
        <store_ui_1.Input ref={password} type="password" name="password" id="password" placeholder={formatMessage({
        id: 'login.page.emailAndPassword.signUpForm.passwordPlaceholder',
        defaultMessage: 'Insert your password',
    })} autoComplete="new-password"/>
        <store_ui_1.Input ref={confirmPwd} type="password" name="password" id="confirm-password" placeholder={formatMessage({
        id: 'login.page.emailAndPassword.signUpForm.confirmPasswordPlaceholder',
        defaultMessage: 'Confirm your password',
    })} autoComplete="new-password"/>

        {state === 'signUpForm.invalidAccessCodeInput' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
        ...
        {state === 'signUpForm.invalidPassword' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
        ...
        {state === 'signUpForm.passwordDoNotMatch' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
        ...
        {state === 'signUpForm.error' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
