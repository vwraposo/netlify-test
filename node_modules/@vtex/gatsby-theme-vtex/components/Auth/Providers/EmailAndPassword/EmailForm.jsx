...
const EmailForm = ({ variant, state: { state }, onSubmit, onBack, }) => {
    ...
    return (<>
      ...
      <store_ui_1.Box as="form" onSubmit={(e) => {
        ...
        <store_ui_1.Input ref={input} type="email" name="email" id="email" placeholder={formatMessage({
        id: 'login.page.emailAndPassword.emailForm.emailPlaceholder',
        defaultMessage: 'Add your email',
    })}/>

        {state === 'emailForm.invalidEmailInput' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
        ...
        {state === 'emailForm.error' && (<store_ui_1.Alert variant="signInDanger">
            {formatMessage({
