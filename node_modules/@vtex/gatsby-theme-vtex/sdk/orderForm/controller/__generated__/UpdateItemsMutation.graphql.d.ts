...
export declare type UpdateItemsMutationMutationVariables = Exact<{
    orderFormId: Maybe<Scalars['ID']>;
    items: Maybe<Array<Maybe<Vtex_ItemInput>>>;
    splitItem: Maybe<Scalars['Boolean']>;
}>;
export declare type UpdateItemsMutationMutation = {
    updateItems: {
        id: string;
        canEditData: boolean;
        loggedIn: boolean;
        ...
        shipping: {
            ...
            isValid: boolean;
            availableAddresses: Maybe<Array<Maybe<{
        ...
        messages: {
            couponMessages: Array<Maybe<{
                code: Maybe<string>;
            }>>;
            generalMessages: Array<Maybe<{
                code: Maybe<string>;
                text: Maybe<string>;
                status: Maybe<string>;
            }>>;
...
export declare const UpdateItemsMutation: {
    query: undefined;
    sha256Hash: string;
