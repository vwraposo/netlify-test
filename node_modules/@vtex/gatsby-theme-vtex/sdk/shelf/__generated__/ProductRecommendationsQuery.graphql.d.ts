...
export declare type ProductRecommendationsQueryQueryVariables = Exact<{
    value: Scalars['ID'];
}>;
export declare type ProductRecommendationsQueryQuery = {
    vtex: {
        productRecommendations: Maybe<Array<Maybe<{
...
export declare const ProductRecommendationsQuery: {
    query: undefined;
    sha256Hash: string;
