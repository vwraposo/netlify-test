...
export declare type HomeViewData = PageViewData;
export declare type ProductPageInfoData = PageViewData;
...
export declare type OrderPlacedData = Order;
export declare type OrderPlacedTrackedData = Order;
