...
/** @license React v16.13.1
     ...
     */(o):o,r}),{}):e}var Ut=function(e,r,n,o){var a=Te(e,r,n,$t(o));return Array.isArray(a)?t.Children.toArray(a):a},Vt=function(e,t){var r=e.defaultRichTextElements,n=u(e,["defaultRichTextElements"]),o=$t(r),a=function l(e,t){var r=function n(e){void 0===e&&(e={dateTime:{},number:{},message:{},relativeTime:{},pluralRules:{},list:{},displayNames:{}});var t=Intl.RelativeTimeFormat,r=Intl.ListFormat,n=Intl.DisplayNames,o=ye((function(){for(var e,t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];return new((e=Intl.DateTimeFormat).bind.apply(e,f([void 0],t)))}),{cache:de(e.dateTime),strategy:ye.strategies.variadic}),a=ye((function(){for(var e,t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];return new((e=Intl.NumberFormat).bind.apply(e,f([void 0],t)))}),{cache:de(e.number),strategy:ye.strategies.variadic}),u=ye((function(){for(var e,t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];return new((e=Intl.PluralRules).bind.apply(e,f([void 0],t)))}),{cache:de(e.pluralRules),strategy:ye.strategies.variadic});return{getDateTimeFormat:o,getNumberFormat:a,getMessageFormat:ye((function(e,t,r,n){return new ae(e,t,r,i({formatters:{getNumberFormat:a,getDateTimeFormat:o,getPluralRules:u}},n||{}))}),{cache:de(e.message),strategy:ye.strategies.variadic}),getRelativeTimeFormat:ye((function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];return new(t.bind.apply(t,f([void 0],e)))}),{cache:de(e.relativeTime),strategy:ye.strategies.variadic}),getPluralRules:u,getListFormat:ye((function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];return new(r.bind.apply(r,f([void 0],e)))}),{cache:de(e.list),strategy:ye.strategies.variadic}),getDisplayNames:ye((function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];return new(n.bind.apply(n,f([void 0],e)))}),{cache:de(e.displayNames),strategy:ye.strategies.variadic})}}(t),o=i(i({},pe),e),a=o.locale,u=o.defaultLocale,l=o.onError;return a?!Intl.NumberFormat.supportedLocalesOf(a).length&&l?l(new se('Missing locale data for locale: "'+a+'" in Intl.NumberFormat. Using default locale: "'+u+'" as fallback. See https://formatjs.io/docs/react-intl#runtime-requirements for more details')):!Intl.DateTimeFormat.supportedLocalesOf(a).length&&l&&l(new se('Missing locale data for locale: "'+a+'" in Intl.DateTimeFormat. Using default locale: "'+u+'" as fallback. See https://formatjs.io/docs/react-intl#runtime-requirements for more details')):(l&&l(new le('"locale" was not configured, using "'+u+'" as fallback. See https://formatjs.io/docs/react-intl/api#intlshape for more details')),o.locale=o.defaultLocale||"en"),i(i({},o),{formatters:r,formatNumber:ke.bind(null,o,r.getNumberFormat),formatNumberToParts:$e.bind(null,o,r.getNumberFormat),formatRelativeTime:Le.bind(null,o,r.getRelativeTimeFormat),formatDate:we.bind(null,o,r.getDateTimeFormat),formatDateToParts:Se.bind(null,o,r.getDateTimeFormat),formatTime:Ie.bind(null,o,r.getDateTimeFormat),formatTimeToParts:Oe.bind(null,o,r.getDateTimeFormat),formatPlural:Me.bind(null,o,r.getPluralRules),formatMessage:Te.bind(null,o,r),formatList:De.bind(null,o,r.getListFormat),formatDisplayName:Ne.bind(null,o,r.getDisplayNames)})}(i(i({},Ve),n),t);return i(i({},a),{formatMessage:Ut.bind(null,{locale:a.locale,timeZone:a.timeZone,formats:a.formats,defaultLocale:a.defaultLocale,defaultFormats:a.defaultFormats,messages:a.messages,onError:a.onError,defaultRichTextElements:o},a.formatters)})},Gt=function(e){function r(){var t=null!==e&&e.apply(this,arguments)||this;return t.cache={dateTime:{},number:{},message:{},relativeTime:{},pluralRules:{},list:{},displayNames:{}},t.state={cache:t.cache,intl:Vt(kt(t.props),t.cache),prevConfig:kt(t.props)},t}return a(r,e),r.getDerivedStateFromProps=function(e,t){var r=t.prevConfig,n=t.cache,o=kt(e);return Ct(r,o)?null:{intl:Vt(o,n),prevConfig:o}},r.prototype.render=function(){return Ue(this.state.intl),t.createElement(Nt,{value:this.state.intl},this.props.children)},r.displayName="IntlProvider",r.defaultProps=Ve,r}(t.PureComponent);function zt(e){var t=Math.abs(e);return t<60?"second":t<3600?"minute":t<86400?"hour":"day"}function Zt(e){switch(e){case"second":return 1;case"minute":return 60;case"hour":return 3600;default:return 86400}}function Yt(e,t){if(!e)return 0;switch(t){case"second":return e;case"minute":return 60*e;default:return 3600*e}}var qt=["second","minute","hour"];function Kt(e){return void 0===e&&(e="second"),qt.includes(e)}var Wt=function(e){function r(t){var r=e.call(this,t)||this;return r._updateTimer=null,r.state={prevUnit:r.props.unit,prevValue:r.props.value,currentValueInSeconds:Kt(r.props.unit)?Yt(r.props.value,r.props.unit):0},F(!t.updateIntervalInSeconds||!(!t.updateIntervalInSeconds||!Kt(t.unit)),"Cannot schedule update with unit longer than hour"),r}return a(r,e),r.prototype.scheduleNextUpdate=function(e,t){var r=this,n=e.updateIntervalInSeconds,o=e.unit,a=t.currentValueInSeconds;if(clearTimeout(this._updateTimer),this._updateTimer=null,n&&Kt(o)){var i=a-n,u=zt(i);if("day"!==u){var l=Zt(u),s=i-i%l,c=s>=a?s-l:s,f=Math.abs(c-a);this._updateTimer=setTimeout((function(){return r.setState({currentValueInSeconds:c})}),1e3*f)}}},r.prototype.componentDidMount=function(){this.scheduleNextUpdate(this.props,this.state)},r.prototype.componentDidUpdate=function(){this.scheduleNextUpdate(this.props,this.state)},r.prototype.componentWillUnmount=function(){clearTimeout(this._updateTimer),this._updateTimer=null},r.getDerivedStateFromProps=function(e,t){return e.unit!==t.prevUnit||e.value!==t.prevValue?{prevValue:e.value,prevUnit:e.unit,currentValueInSeconds:Kt(e.unit)?Yt(e.value,e.unit):0}:null},r.prototype.render=function(){var e=this;return t.createElement(Rt.Consumer,null,(function(r){Ue(r);var n=r.formatRelativeTime,o=r.textComponent,a=e.props,u=a.children,l=a.unit,s=a.updateIntervalInSeconds,c=e.state.currentValueInSeconds,f=a.value||0,m=l;if(Kt(l)&&"number"==typeof c&&s){var p=Zt(m=zt(c));f=Math.round(c/p)}var d=n(f,m,i({},e.props));return"function"==typeof u?u(d):o?t.createElement(o,null,d):d}))},r.displayName="FormattedRelativeTime",r.defaultProps={value:0,unit:"second"},r}(t.PureComponent),Bt=function(e){var r=e.other,n=e.children,o=e.intl,a=o.textComponent,i=e[(0,o.formatPlural)(e.value,e)]||r;return"function"==typeof n?n(i):a?t.createElement(a,null,i):i};Bt.defaultProps={type:"cardinal"},Bt.displayName="FormattedPlural";var Ht=Ft(Bt),Jt=At||xt,Qt=function(e){function r(){return null!==e&&e.apply(this,arguments)||this}return a(r,e),r.prototype.shouldComponentUpdate=function(e){var t=this.props,r=t.values,n=u(t,["values"]),o=e.values,a=u(e,["values"]);return!Jt(o,r)||!Jt(n,a)},r.prototype.render=function(){var e=this;return t.createElement(Rt.Consumer,null,(function(r){Ue(r);var o=r.textComponent,a=e.props,i=a.children,u=a.tagName,l=void 0===u?void 0===o?t.Fragment:o:u,s=(0,r.formatMessage)({id:a.id,description:a.description,defaultMessage:a.defaultMessage},a.values);return Array.isArray(s)||(s=[s]),"function"==typeof i?i(s):l?t.createElement.apply(n,f([l,null],s)):s}))},r.displayName="FormattedMessage",r}(t.Component),Xt=Mt("formatDate"),er=Mt("formatTime"),tr=Mt("formatNumber"),rr=Mt("formatList"),nr=Mt("formatDisplayName"),or=jt("formatDate"),ar=jt("formatTime");e.FormattedDate=Xt,e.FormattedDateParts=or,e.FormattedDisplayName=nr,e.FormattedList=rr,e.FormattedMessage=Qt,e.FormattedNumber=tr,e.FormattedNumberParts=Dt,e.FormattedPlural=Ht,e.FormattedRelativeTime=Wt,e.FormattedTime=er,e.FormattedTimeParts=ar,e.IntlContext=Rt,e.IntlProvider=Gt,e.InvalidConfigError=le,e.MessageFormatError=ce,e.MissingDataError=se,e.MissingTranslationError=fe,e.RawIntlProvider=Nt,e.ReactIntlError=ie,e.UnsupportedFormatterError=ue,e.createIntl=Vt,e.createIntlCache=function ir(){return{dateTime:{},number:{},message:{},relativeTime:{},pluralRules:{},list:{},displayNames:{}}},e.defineMessage=function ur(e){return e},e.defineMessages=function lr(e){return e},e.injectIntl=Ft,e.useIntl=function sr(){var e=t.useContext(Rt);return Ue(e),e},Object.defineProperty(e,"__esModule",{value:!0})}));